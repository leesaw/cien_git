...
<body class="skin-blue">
    ...
    <section class="content-header">
        <h1>
            แสดงชุดวัตถุดิบทั้งหมดในโรงงาน
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> แสดงชุดวัตถุดิบทั้งหมดในโรงงาน</a></li>
        </ol>
    </section>
                            ...
                            <table class="table table-bordered table-striped" id="tablebarcode" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="2" style="text-align:center">ออกจากโรงงาน</th>
                                        <th width="40" rowspan="2" style="text-align:center">จัดการ</th>
                                    </tr>
                                    <tr><th width="60" style="text-align:center">เม็ด</th><th width="60" style="text-align:center">กะรัต</th><th width="40" style="text-align:center">เม็ด</th><th width="40" style="text-align:center">เหลือ</th></tr>
                                </thead>
								<tbody>
