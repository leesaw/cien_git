...
<body class="skin-blue">
    ...
    <section class="content-header">
        <h1>
            แสดงบาร์โค้ดที่กำลังซ่อมทั้งหมด
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> แสดงบาร์โค้ดที่กำลังซ่อมทั้งหมด</a></li>
        </ol>
    </section>
...
{    
    var oTable = $('#tablebarcode').dataTable
        ({
            ...
            'bServerSide'    : false,
            "bDeferRender": true,
            'sAjaxSource'    : '<?php echo site_url("report/ajaxGetAllBarcode_editing"); ?>',
